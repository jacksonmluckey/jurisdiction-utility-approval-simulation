...
complete_config = CityConfig(
    width=200,
    height=200,
    max_density_units_per_km2=37500.0,
    units_noise=0.12,
...
commercial_config = CityConfig(
    ...
    max_office_density_per_km2=7500.0,
    max_shop_density_per_km2=5000.0,
...
corridor_city_config = CityConfig(
    ...
    max_density_units_per_km2=17500.0,
    persons_per_unit=2.5,
    max_office_density_per_km2=10000.0,    # Higher office density
    max_shop_density_per_km2=6250.0,      # Higher shop density
...
downtown_config = CityConfig(
    ...
    max_office_density_per_km2=20000.0,     # CBD-level offices
    max_shop_density_per_km2=12500.0,       # High retail
...
metro_config = CityConfig(
    ...
    max_office_density_per_km2=12500.0,
    max_shop_density_per_km2=7500.0,
...
complete_commercial_config = CityConfig(
    ...
    max_office_density_per_km2=62500.0,
    max_shop_density_per_km2=8750.0,
...
upzone_polycentric = PolycentricConfig(
    num_centers=2,
...
city_no_upzone = City(
    ...
    polycentric_config=upzone_polycentric,
