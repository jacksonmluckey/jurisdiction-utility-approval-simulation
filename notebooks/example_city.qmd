...
polycentric_parks = PolycentricConfig(
    num_centers=3,
    center_distribution="uniform",
    primary_density=28.0,
    density_decay_rate=0.15
)

city_parks = City(
    config=city_config_parks,
    polycentric_config=polycentric_parks,
...
full_polycentric = PolycentricConfig(
    num_centers=5,
    center_distribution="uniform",
    primary_density=35.0,
    density_decay_rate=0.12
...
full_city = City(
    ...
    polycentric_config=full_polycentric,
...
polycentric_zoning = PolycentricConfig(
    num_centers=3,
    center_distribution="uniform",
    primary_density=32.0,
    density_decay_rate=0.13
)

city_zoning = City(
    config=city_config_zoning,
    polycentric_config=polycentric_zoning,
...
commercial_config = CityConfig(
    ...
    max_office_density_per_acre=30.0,
    max_shop_density_per_acre=20.0,
...
polycentric_commercial = PolycentricConfig(
    num_centers=3,
    center_distribution="uniform",
    primary_density=30.0,
    density_decay_rate=0.15
...
city_commercial = City(
    ...
    polycentric_config=polycentric_commercial,
...
corridor_city_config = CityConfig(
    ...
    max_density_units_per_acre=70.0,
    persons_per_unit=2.5,
    max_office_density_per_acre=40.0,    # Higher office density
    max_shop_density_per_acre=25.0,      # Higher shop density
...
polycentric_corridor = PolycentricConfig(
    num_centers=4,
    center_distribution="uniform",
    primary_density=35.0,
    density_decay_rate=0.12
...
city_corridor = City(
    ...
    polycentric_config=polycentric_corridor,
...
downtown_config = CityConfig(
    ...
    max_office_density_per_acre=80.0,     # CBD-level offices
    max_shop_density_per_acre=50.0,       # High retail
...
downtown_polycentric = PolycentricConfig(
    num_centers=1,  # Single downtown
    center_distribution="uniform",
    primary_density=60.0,
...
city_downtown = City(
    ...
    polycentric_config=downtown_polycentric,
...
metro_config = CityConfig(
    ...
    height=80,
    block_area_acres=2.47,
    max_density_units_per_acre=90.0,
    persons_per_unit=2.3,
    max_office_density_per_acre=50.0,
    max_shop_density_per_acre=30.0,
...
metro_polycentric = PolycentricConfig(
    num_centers=6,
    center_distribution="uniform",
    primary_density=45.0,
...
city_metro = City(
    config=metro_config,
    polycentric_config=metro_polycentric,
...
complete_commercial_config = CityConfig(
    ...
    height=100,
    block_area_acres=2.47,
    max_density_units_per_acre=120.0,
    min_density_units_per_acre=2.0,
    persons_per_unit=lambda u, n: 2.9 if u < 30 else 2.1,
    units_noise=0.12,
    # Commercial parameters
    max_office_density_per_acre=250.0,
    max_shop_density_per_acre=35.0,
